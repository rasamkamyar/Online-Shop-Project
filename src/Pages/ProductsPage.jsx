...
import { Card, Loader, Header, SearchBar, CategoryList, Slider } from "../components";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 lg:px-8 mt-4">
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-8">
          {/* Sidebar */}
          <div className="w-full lg:w-1/5 pt-8 lg:pt-8">
          ...
          {/* Main Content */}
          <div className="w-full lg:w-4/5 pt-8 lg:pt-8 mb-3">
            {renderContent()}
          </div>
        </div>
      </div>
